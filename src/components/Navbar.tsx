...
const Navbar = () => {
  ...
  return (
    <Stack>
      <Box backgroundColor="primary.1000" boxShadow="sm" minWidth="1184px" paddingTop="0.50em">
        <Container maxWidth="container.xl">
          <Stack height="6em" marginBottom="3px" spacing={0}>
            ...
            >
              <Stack direction="row" flex={1} spacing={5} padding={2}>
            ...
            justifyContent="space-between">
              <Stack
                ...
                spacing={1}
              >
                 <SlLocationPin style={{ fontSize: "24px", color: "blackAlpha.200"}} />
                            <Box>
                                <Text
                                    fontSize="xs"
                ...
                <Menu>
                  <MenuGroup>
                    <Stack direction="row" spacing={4} width="max-content">
                      ...
                      <MenuButton>
                        <Icon as={BsCart2} height={5} width={5} mb={1} />
                      </MenuButton>
                    </Stack>
                  </MenuGroup>
                </Menu>
